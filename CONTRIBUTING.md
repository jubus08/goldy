...
The GOLDY project operates an open contributor model where anyone is
...
The following applies to code changes to the GOLDY project, and is not to be
confused with overall GOLDY COIN Network Protocol consensus changes.

Whether a pull request is merged into GOLDY rests with the project merge
...
Patches that change GOLDY COIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the GOLDY COIN consensus, it must have been
...
The project leader is the release manager for each GOLDY release.
