...
In order to support loading of multiple wallets in goldy-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is goldy.cpp.
...
Changes to goldy.cpp
----------------------
goldy.cpp is the entry point into goldy-qt, and as such, will require some minor modifications to provide hooks for
