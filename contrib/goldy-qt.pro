...
RESOURCES += src/qt/goldy.qrc src/qt/goldy_locale.qrc

TRANSLATIONS += src/qt/locale/goldy_bg.ts \
                src/qt/locale/goldy_de.ts \
                src/qt/locale/goldy_en.ts \
                src/qt/locale/goldy_es.ts \
                src/qt/locale/goldy_fi.ts \
                src/qt/locale/goldy_fr.ts \
                src/qt/locale/goldy_it.ts \
                src/qt/locale/goldy_ja.ts \
                src/qt/locale/goldy_pl.ts \
                src/qt/locale/goldy_pt.ts \
                src/qt/locale/goldy_ru.ts \
                src/qt/locale/goldy_sk.ts \
                src/qt/locale/goldy_sv.ts \
                src/qt/locale/goldy_vi.ts \
                src/qt/locale/goldy_zh_CN.ts \
                src/qt/locale/goldy_zh_TW.ts
