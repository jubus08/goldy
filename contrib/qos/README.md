...
This means one can have an always-on goldyd instance running, and another local goldyd/goldy-qt instance which connects to this node and receives blocks from it.
