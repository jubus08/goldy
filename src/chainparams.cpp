...
// Copyright (c) 2015-2017 The PIVX Developers, The Goldy Developers
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 30001;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Goldy starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 3 * 60; // Goldy: 1 minute (aka every block)
        nTargetSpacing = 3 * 60;  // Goldy: 1 minute
        nLastPOWBlock = 500;
        nMaturity = 30;
        nMasternodeCountDrift = 20;
        nModifierUpdateBlock = 510;
        nMaxMoneyOut = 300000000 * COIN;
        nNewMasternodeCollateral_StartBlock = 40; // Nov 7, 2018 (approximately)
	nNewMasternodeCollateral_GPBlock = 41; // 1 week grace period to allow for masternodes to activate using the new collateral
        nNewMasternode_Collateral = 100000;
        nOriginalMasternode_Collateral = 100000;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Goldy: 1 minute
        nTargetSpacing = 1 * 60;  // Goldy: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("seeds.goldy.io", "seeds.goldy.io"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 56); // Testnet goldy addresses start with 'P'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 50);  // Testnet goldy script addresses start with 'M'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 184);     // Testnet private keys start with 2
        // Testnet goldy BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet goldy BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet goldy BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // GOLDY: 1 day
        nTargetSpacing = 1 * 60;        // GOLDY: 1 minutes
