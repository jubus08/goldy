...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GOLDY COIN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and goldy: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GOLDY"), this);
    aboutAction->setStatusTip(tr("Show information about GOLDY"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GOLDY COIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GOLDY COIN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GOLDY COIN addresses"));
    ...
    openAction->setStatusTip(tr("Open a GOLDY COIN: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GOLDY help message to get a list with possible GOLDY COIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GOLDY client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GOLDY COIN network", "", count));
}
...
{
    QString strTitle = tr("GOLDY"); // default title
