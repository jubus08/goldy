...
/** Utility functions used by the GOLDY COIN Qt UI.
 */
namespace GUIUtil
{
...
// Render GOLDY COIN addresses in monospace font
...
// Parse "goldy:" URI into recipient object, return true on successful parsing
