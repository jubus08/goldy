...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("GOLDY RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  goldy-cli [options] <command> [params]  " + _("Send command to GOLDY") + "\n" +
                        "  goldy-cli [options] help                " + _("List commands") + "\n" +
                        "  goldy-cli [options] help <command>      " + _("Get help for a command") + "\n";
