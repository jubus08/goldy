...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop GOLDY COIN server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "GOLDY COIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GOLDY features */
        {"goldy", "masternode", &masternode, true, true, false},
        {"goldy", "listmasternodes", &listmasternodes, true, true, false},
        {"goldy", "getmasternodecount", &getmasternodecount, true, true, false},
        {"goldy", "masternodeconnect", &masternodeconnect, true, true, false},
        {"goldy", "masternodecurrent", &masternodecurrent, true, true, false},
        {"goldy", "masternodedebug", &masternodedebug, true, true, false},
        {"goldy", "startmasternode", &startmasternode, true, true, false},
        {"goldy", "createmasternodekey", &createmasternodekey, true, true, false},
        {"goldy", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"goldy", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"goldy", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"goldy", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"goldy", "getmasternodescores", &getmasternodescores, true, true, false},
        {"goldy", "mnbudget", &mnbudget, true, true, false},
        {"goldy", "preparebudget", &preparebudget, true, true, false},
        {"goldy", "submitbudget", &submitbudget, true, true, false},
        {"goldy", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"goldy", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"goldy", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"goldy", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"goldy", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"goldy", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"goldy", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"goldy", "checkbudgets", &checkbudgets, true, true, false},
        {"goldy", "mnsync", &mnsync, true, true, false},
        {"goldy", "spork", &spork, true, true, false},
        {"goldy", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"goldy", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use goldyd, or the -server option to goldy-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> goldy-cli " + methodname + " " + args + "\n";
}
