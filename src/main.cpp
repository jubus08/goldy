...
#if defined(NDEBUG)
#error "GOLDY COIN cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	} else if (nHeight >= 501 && nHeight < 123314) {
    	return 50 * COIN;
    } else if (nHeight >= 123314 && nHeight < 131282) {
    	return 50 * COIN;
    } else if (nHeight >= 131282 && nHeight < 197035) {
    	return 50 * COIN;
    } else if (nHeight >= 197035 && nHeight < 241675) { 
    	return 50 * COIN;
    } else if (nHeight >= 241675 && nHeight < 286315) { 
    	return 50 * COIN;
    } else if (nHeight >= 286315) { 
    	return 50 * COIN;
    }
...
bool CheckWork(const CBlock block, CBlockIndex* const pindexPrev)
{
	...
	uiInterface.ThreadSafeMessageBox(_("You are on the wrong chain.  Please check debug.log for more information on resolving this.  Shutting down."), "", CClientUIInterface::MSG_ERROR);
        LogPrintf("Your block database is from a forked version of the correct chain.  Please visit https://github.com/GOLDYCoin/bootstrap to avoid any potential loss of future rewards and get on the proper chain.\n");
        StartShutdown();
        return false;
      }
    }
